...
public class DragRigidbody : MonoBehaviour
{
	...
	private void Update()
	{
		if (Input.GetMouseButtonDown(0) && Physics.Raycast(FindCamera().ScreenPointToRay(Input.mousePosition), out var hitInfo, maxDistance) && (bool)hitInfo.rigidbody && !hitInfo.rigidbody.isKinematic)
		{
			if (!springJoint)
			{
